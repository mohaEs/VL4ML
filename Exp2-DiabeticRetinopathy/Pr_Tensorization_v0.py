...
def FnCreateTargetImages(Labels):
    ...
    for i in range(len(Labels)):
        ...
        if Labels[i]==0:
            ...
            OutputImages[i,6:17,6:17,0]=0.8
            OutputImages[i,6:17,6:17,1]=0.8
            OutputImages[i,6:17,6:17,2]=0.8
            ...
            OutputImages[i,6:17,6:17,0]=0.4
            OutputImages[i,6:17,6:17,1]=0.4
            OutputImages[i,6:17,6:17,2]=0.4
            ...
            OutputImages[i,6:17,6:17,0]=0.2
            OutputImages[i,6:17,6:17,1]=0.2
            OutputImages[i,6:17,6:17,2]=0.2
...
for repeator in range(0,1):
    ...
    for train, test in kfold.split(X_all[:,0], y_all[:]):
        ...
        for i in range(200):#range(len(test)):            
            plt.figure(1)
            plt.subplot(121)
